...
-- Не понял задание, но как-то так (скопировал строки из Ubuntu после выполнения):
...
/* 2) NoSQL. При помощи базы данных Redis решите задачу поиска имени пользователя по электронному адресу и наоборот,
