...
--ѕредставление дл€ просмотра дефицита товара (соотношени€ между заказами и наличием на складе):
...
-- ѕредставление дл€ оценки статистики продаж разных категорий фасадов (по сумме продаж и количеству заказов):
...
-- ѕредставление дл€ оценки статистики продаж по магазинам:
